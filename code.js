...
function calcArea() {
	...
	if(!+(areaArray[i][0])) {
		...
		switch(areaArray[i][1]) {
			//Circle
			case 0:
				showCircleArea(i,areaArray[i][2]*2,Math.abs(areaArray[i][4]),Math.abs(areaArray[i][5]))
				break;
			...
			//Section
			case 4:
				showSectionArea(i,areaArray[i][2]*2,areaArray[i][3],Math.abs(areaArray[i][4]),Math.abs(areaArray[i][5]))
				break;
